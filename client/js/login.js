...
(function init(){
   ...
   if (cookie.edienilno_username) {
      ui.login.username.value = cookie.edienilno_username;
...
function login() {
   ...
   ajax({
      ...
      set_cookie('edienilno_username', username);
      set_cookie('edienilno_uuid', response.uuid);
